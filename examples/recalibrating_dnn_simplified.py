...
# Market under study.
# If it is not one of the standard ones, the file name
...
# "%Y-%m-%d %H:%M"
begin_test_date = '2016-12-27'
end_test_date = '2017-03-01'

# Set up the paths for saving data (these are the defaults for the library)
path_datasets_folder = os.path.join('.', 'datasets')
path_recalibration_folder = os.path.join('.', 'experimental_files')
path_hyperparameter_folder = os.path.join('.', 'experimental_files')

evaluate_dnn_in_test_dataset(experiment_id=str(experiment_id), path_hyperparameter_folder=path_hyperparameter_folder,
